<!-- ARCHIVED phase plan — recovered from git history. Source: docs/PLAN.md @ 9f56f5b
     2026-07-22 — plan: the proactive mana planner (finite-mana MODE, beta toggle) — docs/PLAN.md
