<!-- ARCHIVED phase plan — recovered from git history. Source: docs/PLAN.md @ 7e00e9d
     2026-07-21 — docs: PLAN.md — rigorous wowsims harness audit + ramp-aware SP valuation (approved)
