<!-- ARCHIVED phase plan — recovered from git history. Source: docs/PLAN.md @ f456715
     2026-07-22 — plan: Phase 3 — raid-buff/proc tightening + deterministic mana & haste helpers
